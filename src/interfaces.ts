...
export interface TodoValueStateProps {
...
export type TodoFilterStatePropsFilter =
  | "All"
  | "Active"
  | "Completed"
  | "Clear";
export interface TodoFilterStateProps {
  filter: TodoFilterStatePropsFilter;
  setFilter?: React.Dispatch<
    React.SetStateAction<"All" | "Active" | "Completed" | "Clear">
  >;
}
