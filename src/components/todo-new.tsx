...
import { TodoNewProps } from "../interfaces";
...
export const TodoNew = (props: TodoNewProps) => {
  ...
  return (
    <div
      className={
        props.isShow ? "TodoNew--show TodoNew" : "TodoNew--hide TodoNew"
      }
    >
      <div
        data-testid="TodoNew__Icon"
        className="TodoNew__Icon"
        onClick={changeShow}
      >
